...
import { errorAlertMessage, showErrorMessage, showSuccessMessage } from "./util.js";
...
const getData = () => {
  fetch(
    ...
    .catch(() => {
      errorAlertMessage('При загрузке данных произошла ошибка, попробуйте перезагрузить страницу');
    });
};
